...
ms.date: 1/20/2017
content_git_url: https://github.com/Azure/azure-docs-powershell/blob/live/azureps-cmdlets-docs/ServiceManagement/Azure.SQLDatabase/v3.4.0/New-AzureSqlDatabaseServerContext.md
original_content_git_url: https://github.com/Azure/azure-docs-powershell/blob/live/azureps-cmdlets-docs/ServiceManagement/Azure.SQLDatabase/v3.4.0/New-AzureSqlDatabaseServerContext.md
gitcommit: https://github.com/Azure/azure-docs-powershell/blob/cb06bb906911a2a2e1f57adbafe0c0c97a0b205b/azureps-cmdlets-docs/ServiceManagement/Azure.SQLDatabase/v3.4.0/New-AzureSqlDatabaseServerContext.md
ms.topic: reference
ms.prod: powershell
...
[Get-AzureSqlDatabase](xref:ServiceManagement/Azure.SQLDatabase/v3.4.0/Get-AzureSqlDatabase.md)

[New-AzureSqlDatabase](xref:ServiceManagement/Azure.SQLDatabase/v3.4.0/New-AzureSqlDatabase.md)

[Remove-AzureSqlDatabase](xref:ServiceManagement/Azure.SQLDatabase/v3.4.0/Remove-AzureSqlDatabase.md)

[Set-AzureSqlDatabase](xref:ServiceManagement/Azure.SQLDatabase/v3.4.0/Set-AzureSqlDatabase.md)
