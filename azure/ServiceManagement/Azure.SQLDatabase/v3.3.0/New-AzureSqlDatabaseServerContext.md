...
ms.date: 1/11/2017
content_git_url: https://github.com/Azure/azure-docs-powershell/blob/live/azureps-cmdlets-docs/ServiceManagement/Azure.SQLDatabase/v3.3.0/New-AzureSqlDatabaseServerContext.md
original_content_git_url: https://github.com/Azure/azure-docs-powershell/blob/live/azureps-cmdlets-docs/ServiceManagement/Azure.SQLDatabase/v3.3.0/New-AzureSqlDatabaseServerContext.md
gitcommit: https://github.com/Azure/azure-docs-powershell/blob/cf5fb15dcd1fe2c86458f47e1a11dc88817021fc/azureps-cmdlets-docs/ServiceManagement/Azure.SQLDatabase/v3.3.0/New-AzureSqlDatabaseServerContext.md
ms.topic: reference
ms.prod: powershell
...
[Azure SQL Database Cmdlets](xref:ServiceManagement/Azure.SQLDatabase/v3.3.0/Azure.SQLDatabase.md)

[Get-AzureSqlDatabase](xref:ServiceManagement/Azure.SQLDatabase/v3.3.0/Get-AzureSqlDatabase.md)

[New-AzureSqlDatabase](xref:ServiceManagement/Azure.SQLDatabase/v3.3.0/New-AzureSqlDatabase.md)

[Remove-AzureSqlDatabase](xref:ServiceManagement/Azure.SQLDatabase/v3.3.0/Remove-AzureSqlDatabase.md)

[Set-AzureSqlDatabase](xref:ServiceManagement/Azure.SQLDatabase/v3.3.0/Set-AzureSqlDatabase.md)
