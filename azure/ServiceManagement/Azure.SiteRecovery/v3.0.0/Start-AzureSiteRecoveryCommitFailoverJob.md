...
online version: 
schema: 2.0.0
ms.assetid: 84F47A61-A253-476D-9A9F-52672EEA5760
updated_at: 11/11/2016 11:03 PM
ms.date: 11/11/2016
content_git_url: https://github.com/Azure/azure-docs-powershell/blob/master/azureps-cmdlets-docs/ServiceManagement/Azure.SiteRecovery/v3.0.0/Start-AzureSiteRecoveryCommitFailoverJob.md
original_content_git_url: https://github.com/Azure/azure-docs-powershell/blob/master/azureps-cmdlets-docs/ServiceManagement/Azure.SiteRecovery/v3.0.0/Start-AzureSiteRecoveryCommitFailoverJob.md
gitcommit: https://github.com/Azure/azure-docs-powershell/blob/79eeb985ea480979357fb4695832a0c3d29a48bf/azureps-cmdlets-docs/ServiceManagement/Azure.SiteRecovery/v3.0.0/Start-AzureSiteRecoveryCommitFailoverJob.md
ms.topic: reference
ms.prod: powershell
...
[Start-AzureSiteRecoveryPlannedFailoverJob](xref:ServiceManagement/Azure.SiteRecovery/v3.0.0/Start-AzureSiteRecoveryPlannedFailoverJob.md)

[Start-AzureSiteRecoveryUnplannedFailoverJob](xref:ServiceManagement/Azure.SiteRecovery/v3.0.0/Start-AzureSiteRecoveryUnplannedFailoverJob.md)
