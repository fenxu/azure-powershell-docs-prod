...
ms.date: 1/20/2017
content_git_url: https://github.com/Azure/azure-docs-powershell/blob/live/azureps-cmdlets-docs/ServiceManagement/Azure.Service/v3.4.0/Remove-AzureDisk.md
original_content_git_url: https://github.com/Azure/azure-docs-powershell/blob/live/azureps-cmdlets-docs/ServiceManagement/Azure.Service/v3.4.0/Remove-AzureDisk.md
gitcommit: https://github.com/Azure/azure-docs-powershell/blob/cb06bb906911a2a2e1f57adbafe0c0c97a0b205b/azureps-cmdlets-docs/ServiceManagement/Azure.Service/v3.4.0/Remove-AzureDisk.md
ms.topic: reference
ms.prod: powershell
...
[Add-AzureDisk](xref:ServiceManagement/Azure.Service/v3.4.0/Add-AzureDisk.md)

[Get-AzureDisk](xref:ServiceManagement/Azure.Service/v3.4.0/Get-AzureDisk.md)

[Update-AzureDisk](xref:ServiceManagement/Azure.Service/v3.4.0/Update-AzureDisk.md)
