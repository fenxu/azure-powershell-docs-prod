...
ms.date: 1/20/2017
content_git_url: https://github.com/Azure/azure-docs-powershell/blob/live/azureps-cmdlets-docs/ServiceManagement/Azure.Service/v3.4.0/Remove-AzureDataDisk.md
original_content_git_url: https://github.com/Azure/azure-docs-powershell/blob/live/azureps-cmdlets-docs/ServiceManagement/Azure.Service/v3.4.0/Remove-AzureDataDisk.md
gitcommit: https://github.com/Azure/azure-docs-powershell/blob/cb06bb906911a2a2e1f57adbafe0c0c97a0b205b/azureps-cmdlets-docs/ServiceManagement/Azure.Service/v3.4.0/Remove-AzureDataDisk.md
ms.topic: reference
ms.prod: powershell
...
[Add-AzureDataDisk](xref:ServiceManagement/Azure.Service/v3.4.0/Add-AzureDataDisk.md)

[Get-AzureDataDisk](xref:ServiceManagement/Azure.Service/v3.4.0/Get-AzureDataDisk.md)

[Get-AzureVM](xref:ServiceManagement/Azure.Service/v3.4.0/Get-AzureVM.md)

[Set-AzureDataDisk](xref:ServiceManagement/Azure.Service/v3.4.0/Set-AzureDataDisk.md)
