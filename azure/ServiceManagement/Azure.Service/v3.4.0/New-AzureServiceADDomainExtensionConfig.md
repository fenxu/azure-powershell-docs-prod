...
ms.date: 1/20/2017
content_git_url: https://github.com/Azure/azure-docs-powershell/blob/live/azureps-cmdlets-docs/ServiceManagement/Azure.Service/v3.4.0/New-AzureServiceADDomainExtensionConfig.md
original_content_git_url: https://github.com/Azure/azure-docs-powershell/blob/live/azureps-cmdlets-docs/ServiceManagement/Azure.Service/v3.4.0/New-AzureServiceADDomainExtensionConfig.md
gitcommit: https://github.com/Azure/azure-docs-powershell/blob/cb06bb906911a2a2e1f57adbafe0c0c97a0b205b/azureps-cmdlets-docs/ServiceManagement/Azure.Service/v3.4.0/New-AzureServiceADDomainExtensionConfig.md
ms.topic: reference
ms.prod: powershell
...
```yaml
Type: String
Parameter Sets: JoinDomainUsingJoinOptionAndThumbprint, WorkGroupNameThumbprint, JoinDomainUsingEnumOptionsAndThumbprint
Aliases: 
...
[Get-AzureServiceADDomainExtension](xref:ServiceManagement/Azure.Service/v3.4.0/Get-AzureServiceADDomainExtension.md)

[Set-AzureServiceADDomainExtension](xref:ServiceManagement/Azure.Service/v3.4.0/Set-AzureServiceADDomainExtension.md)
