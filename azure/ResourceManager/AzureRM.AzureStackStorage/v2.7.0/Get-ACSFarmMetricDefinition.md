...
ms.date: 3/11/2017
content_git_url: https://github.com/Azure/azure-docs-powershell/blob/master/azureps-cmdlets-docs/ResourceManager/AzureRM.AzureStackStorage/v2.7.0/Get-ACSFarmMetricDefinition.md
original_content_git_url: https://github.com/Azure/azure-docs-powershell/blob/master/azureps-cmdlets-docs/ResourceManager/AzureRM.AzureStackStorage/v2.7.0/Get-ACSFarmMetricDefinition.md
gitcommit: https://github.com/Azure/azure-docs-powershell/blob/04f63f6e685743ace2c57eb157574e34e8610b1c/azureps-cmdlets-docs/ResourceManager/AzureRM.AzureStackStorage/v2.7.0/Get-ACSFarmMetricDefinition.md
ms.topic: reference
ms.prod: powershell
...
## DESCRIPTION
The **Get-ACSFarmMetricDefinition** cmdlet returns metric definitions for a storage farm.
...
**Get-ACSFarmMetricDefinition** returns information about the metrics available for use with storage farms, including such things as the metric name, the metric data type, and a brief definition of what the metric actually does.
...
**Get-ACSFarmMetricDefinition** only returns information about the metrics available for use.
To return the actual values, use the Get-ACSFarmMetric cmdlet.

## EXAMPLES

### Example 1: Get storage farm metric definitions
```
PS C:\> Get-ACSFarmMetricDefinition -FarmName "ContosoFarm" -ResourceGroupName "ContosoResourceGroup"
```

This command returns metric definitions for the storage farm ContosoFarm.

## PARAMETERS

### -FarmName
Specifies the name of the storage farm for which the metric definitions are being returned.
For example:
...
By default, **Get-ACSFarmMetricDefinition** returns only a partial definition for each metric.
...
[Get-ACSFarm](xref:ResourceManager/AzureRM.AzureStackStorage/v2.7.0/Get-ACSFarm.md)

[Get-ACSFarmMetric](xref:ResourceManager/AzureRM.AzureStackStorage/v2.7.0/Get-ACSFarmMetric.md)
