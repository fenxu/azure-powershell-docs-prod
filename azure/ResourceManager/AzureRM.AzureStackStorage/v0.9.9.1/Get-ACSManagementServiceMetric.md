...
online version: 
schema: 2.0.0
ms.assetid: 79502042-7862-4BF6-8AD7-C63989642C35
updated_at: 11/15/2016 8:02 AM
ms.date: 11/15/2016
content_git_url: https://github.com/Azure/azure-docs-powershell/blob/master/azureps-cmdlets-docs/ResourceManager/AzureRM.AzureStackStorage/v0.9.9.1/Get-ACSManagementServiceMetric.md
original_content_git_url: https://github.com/Azure/azure-docs-powershell/blob/master/azureps-cmdlets-docs/ResourceManager/AzureRM.AzureStackStorage/v0.9.9.1/Get-ACSManagementServiceMetric.md
gitcommit: https://github.com/Azure/azure-docs-powershell/blob/16dcbb293b24fa241864048736125047ff62e2ea/azureps-cmdlets-docs/ResourceManager/AzureRM.AzureStackStorage/v0.9.9.1/Get-ACSManagementServiceMetric.md
ms.topic: reference
ms.prod: powershell
...
# Get-ACSManagementServiceMetric
...
```
Get-ACSManagementServiceMetric [-FarmName] <String> [[-TimeGrain] <TimeGrain>] [[-StartTime] <DateTime>]
...
## DESCRIPTION
The **Get-ACSManagementServiceMetric** cmdlet returns for a storage management service.
...
**Get-ACSManagementServiceMetric** returns the actual metric values for a storage management service.
To return information about the management service metrics available for use, including a definition of each metric, use the Get-ACSFarmMetricDefinition cmdlet.

## EXAMPLES

### Example 1: Get storage management service metrics
```
PS C:\> Get-ACSManagementServiceMetric -FarmName "ContosoFarm" -ResourceGroupName "ContosoResourceGroup"
```

This command returns metrics for the storage management service associated with the storage farm ContosoFarm.

## PARAMETERS

### -FarmName
Specifies the name of the storage farm associated with the target management service.
For example:
...
If you do not use these parameters then **Get-ACSManagementServiceMetric** returns all the available data regardless of date.
...
### -ResourceGroupName
Specifies the name of the resource group associated with the target storage management service.
For example:
...
By default, **Get-ACSManagementServiceMetric** returns only partial data for each metric.
...
[Get-ACSManagementService](xref:ResourceManager/AzureRM.AzureStackStorage/v0.9.9.1/Get-ACSManagementService.md)

[Get-ACSManagementServiceMetricDefinition](xref:ResourceManager/AzureRM.AzureStackStorage/v0.9.9.1/Get-ACSManagementServiceMetricDefinition.md)
