...
ms.date: 11/15/2016
content_git_url: https://github.com/Azure/azure-docs-powershell/blob/master/azureps-cmdlets-docs/ResourceManager/AzureRM.AzureStackStorage/v0.9.9.1/Get-ACSShareMetricDefinition.md
original_content_git_url: https://github.com/Azure/azure-docs-powershell/blob/master/azureps-cmdlets-docs/ResourceManager/AzureRM.AzureStackStorage/v0.9.9.1/Get-ACSShareMetricDefinition.md
gitcommit: https://github.com/Azure/azure-docs-powershell/blob/16dcbb293b24fa241864048736125047ff62e2ea/azureps-cmdlets-docs/ResourceManager/AzureRM.AzureStackStorage/v0.9.9.1/Get-ACSShareMetricDefinition.md
ms.topic: reference
ms.prod: powershell
...
[Get-ACSShare](xref:ResourceManager/AzureRM.AzureStackStorage/v0.9.9.1/Get-ACSShare.md)

[Get-ACSShareMetric](xref:ResourceManager/AzureRM.AzureStackStorage/v0.9.9.1/Get-ACSShareMetric.md)
