...
gitcommit: https://github.com/Azure/azure-docs-powershell/blob/4c2b53e3d672000ccbb89d60d0e1ca6164faa338/azureps-cmdlets-docs/index.md
ms.topic: reference
...
Azure PowerShell can be installed it from the PowerShell Gallery, using the Web Platform Installer (WebPI),
or using the MSI file available from
...
* Installing from the PowerShell Gallery
    ...
    + `Install-Module Azure` installs the Azure module. This module is the Service Management module
      ...
      previous version of the Azure module. * Installing Azure PowerShell from WebPI

* Installing from WebPI
