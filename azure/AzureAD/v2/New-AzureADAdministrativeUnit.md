...
gitcommit: https://github.com/Azure/azure-docs-powershell-azuread/blob/e79870303c4a5b18f88c61a5fe206bd45af8c480/Azure%20AD%20Cmdlets/AzureAD/v2/New-AzureADAdministrativeUnit.md
ms.topic: reference
...
```
New-AzureADAdministrativeUnit [-Description <String>] -DisplayName <String>
```
